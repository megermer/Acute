...
sentence1 = "A rare atmospheric phenomenon combines humidity with cinnamon trees."
sentence2 = "A atmospheric phenomenon uses both the humidity with cinnamon plants."
